...
public class ComputerChair extends Chair {
    ...
    public ComputerChair(String model, int numberOfLegs, Float price,boolean adjustments,boolean spinning ,int discountAmount) {
    ...
    public String printChair() {
        String format = String.format("[Chair: %s][Computer chair: adjustments: %s,spinning: %s,discount: %s,discountAmount: %d]", super.printChair(), this.adjustments,this.spinning, GetDiscount(), getDiscountAmount());
        return format;
    }
